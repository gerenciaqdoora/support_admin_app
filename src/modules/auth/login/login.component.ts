...
@Component({
  ...
  template: `
    <div
      class="min-h-screen bg-slate-50 flex items-center justify-center p-6 font-sans relative overflow-hidden"
    >
      <!-- Premium Ambient Decorations -->
      <div
        class="absolute left-[-10%] bottom-[-10%] w-[40%] h-[50%] pointer-events-none hidden lg:block animate-float"
      >
      ...
      <div
        class="absolute right-[-10%] top-[-10%] w-[40%] h-[50%] pointer-events-none hidden lg:block animate-float-delayed"
      >
        <div class="relative w-full h-full flex items-center justify-center">
          <svg
            class="absolute inset-0 w-full h-full opacity-15"
          ...
          >
            <path
              fill="#4C9AFF"
              d="M39.9,-65.7C54.1,-60.5,69.5,-53.9,77.4,-42.1C85.3,-30.3,85.6,-13.2,82.8,2.7C80,18.7,74.1,33.5,64.2,45.4C54.4,57.3,40.6,66.4,25.8,71.1C11,75.8,-4.8,76.1,-20,72.4C-35.3,68.7,-50,61,-60.8,49.5C-71.6,38,-78.6,22.7,-80.7,6.8C-82.8,-9.1,-80,-25.6,-71.8,-39.3C-63.5,-53.1,-49.8,-64.1,-35.3,-69C-20.7,-73.9,-5.3,-72.7,6.5,-63.9C18.3,-55.1,25.8,-70.9,39.9,-65.7Z"
              transform="translate(100 100)"
            />
          </svg>
          <img
      ...
      <div
        ...
        style="background-image: radial-gradient(#0052CC 1px, transparent 1px); background-size: 40px 40px;"
      ></div>

      <div
        class="max-w-[400px] w-full bg-white/90 backdrop-blur-md rounded-sm shadow-[0_20px_48px_-12px_rgba(9,30,66,0.2)] border border-[#DFE1E6] p-10 z-10 animate-in fade-in zoom-in duration-500"
      >
        <!-- Header -->
        <div class="flex flex-col items-center mb-8">
          <div class="mb-6">
            <img
              src="/images/qdoora/QdoorA-negro-para-fondo-blanco.png"
              class="h-22 w-auto object-contain"
              alt="QdoorA Logo"
            />
          </div>
          <h1 class="text-[#172B4D] text-lg font-bold text-center">
        ...
        <form [formGroup]="loginForm" (ngSubmit)="onSubmit()" class="space-y-4">
          ...
          @if (errorMessage()) {
            <div
              class="p-3 rounded-sm bg-red-50 border-l-4 border-red-500 text-red-700 text-xs font-medium flex items-center gap-2 animate-in slide-in-from-top-2"
            >
          ...
          <div class="pt-4 flex flex-col items-center gap-3 border-t border-[#DFE1E6]">
            <a href="#" class="text-sm text-[#0052CC] hover:underline font-medium"
        ...
        <!-- Footer -->
        <div class="mt-4 text-center space-y-2 border-t border-[#DFE1E6] pt-6">
          <p class="text-[10px] text-[#6B778C] font-bold uppercase tracking-widest">
            Portal de Soporte Qdoora
          </p>
          <p class="text-[10px] text-[#6B778C]">
            Acceso seguro a servicios corporativos unificados
          </p>
        </div>
      </div>
    </div>
