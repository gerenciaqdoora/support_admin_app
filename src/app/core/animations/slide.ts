...
import {
    QdooraAnimationCurves,
    QdooraAnimationDurations,
} from './defaults';
...
const slideInTop = trigger('slideInTop', [
    ...
    transition('void => *', animate('{{timings}}'), {
        params: {
            timings: `${QdooraAnimationDurations.entering} ${QdooraAnimationCurves.deceleration}`,
        },
    }),
]);
...
const slideOutTop = trigger('slideOutTop', [
    ...
    transition('* => void', animate('{{timings}}'), {
        params: {
            timings: `${QdooraAnimationDurations.exiting} ${QdooraAnimationCurves.acceleration}`,
        },
    }),
]);
