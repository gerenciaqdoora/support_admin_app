...
export class QdooraNavigationService {
    private _componentRegistry: Map<string, any> = new Map<string, any>();
    private _navigationStore: Map<string, QdooraNavigationItem[]> = new Map<
        string,
        any
    >();
     ...
     * @param navigation
     */
    storeNavigation(key: string, navigation: QdooraNavigationItem[]): void {
        // Add to the store
     ...
     * @param key
     */
    getNavigation(key: string): QdooraNavigationItem[] {
     ...
     */
    getFlatNavigation(
        navigation: QdooraNavigationItem[],
        flatNavigation: QdooraNavigationItem[] = []
    ...
    getItemParent(
        id: string,
        navigation: QdooraNavigationItem[],
        parent: QdooraNavigationItem[] | QdooraNavigationItem
    ): QdooraNavigationItem[] | QdooraNavigationItem | null {
        for (const item of navigation) {
            if (item.id === id) {
                return parent;
            }
