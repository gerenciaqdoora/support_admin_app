...
@Component({
    selector: 'qdoora-vertical-navigation-collapsable-item',
    ...
    imports: [
        ...
        forwardRef(() => QdooraVerticalNavigationCollapsableItemComponent),
...
export class QdooraVerticalNavigationCollapsableItemComponent
    implements OnInit, OnDestroy
{
    ...
    @HostBinding('class') get classList(): any {
        /* eslint-disable @typescript-eslint/naming-convention */
        return {
            'qdoora-vertical-navigation-item-collapsed': this.isCollapsed,
            'qdoora-vertical-navigation-item-expanded': this.isExpanded,
        };
        /* eslint-enable @typescript-eslint/naming-convention */
    }
    ...
    ngOnInit(): void {
        ...
        this._qdooraVerticalNavigationComponent.onCollapsableItemCollapsed
        ...
        if (this.autoCollapse) {
            this._qdooraVerticalNavigationComponent.onCollapsableItemExpanded
                .pipe(takeUntil(this._unsubscribeAll))
    ...
    collapse(): void {
        ...
        this._qdooraVerticalNavigationComponent.onCollapsableItemCollapsed.next(
            this.item
        );
    }
    ...
    expand(): void {
        ...
        // Execute the observable
        this._qdooraVerticalNavigationComponent.onCollapsableItemExpanded.next(
            this.item
        );
    }
