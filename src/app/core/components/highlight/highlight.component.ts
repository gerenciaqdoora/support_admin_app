...
import { QdooraHighlightService } from '@core/components/highlight/highlight.service';

@Component({
    selector: 'textarea[qdoora-highlight]',
    templateUrl: './highlight.component.html',
    styleUrls: ['./highlight.component.scss'],
    encapsulation: ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush,
    exportAs: 'qdooraHighlight',
    standalone: true,
    imports: [NgClass],
})
export class QdooraHighlightComponent implements OnChanges, AfterViewInit {
    private _domSanitizer = inject(DomSanitizer);
    private _elementRef = inject(ElementRef);
    private _qdooraHighlightService = inject(QdooraHighlightService);
    ...
    private _highlightAndInsert(): void {
        ...
        this.highlightedCode = this._domSanitizer.sanitize(
            ...
            this._qdooraHighlightService.highlight(this.code, this.lang)
        );
